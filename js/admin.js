...
jQuery(document).ready(function ($) {
    ...
    $(document).on('click', '.formWrapper input', function () {
    ...
    $(document).on('click', '.addInput', function () {
        ...
        const inputText = '<div class="form-control d-flex flex-column"><label for="input-' + randomNumber + '">Input text</label><input input-text id="input-' + randomNumber + '" type="text" name="name" value="" /></div>';
        const inputPrice = '<div class="form-control d-flex flex-column"><label for="input-' + randomNumber + '">Price amount</label><input input-price id="input-' + randomNumber + '" type="number" name="price" value="" /></div>';
        const inputEmail = '<div class="form-control d-flex flex-column"><label for="input-' + randomNumber + '">E-mail</label><input input-email id="input-' + randomNumber + '" type="email" name="email" value="" /></div>';
        const inputPhone = '<div class="form-control d-flex flex-column"><label for="input-' + randomNumber + '">Phone</label><input input-phone id="input-' + randomNumber + '" type="tel" name="phone" value="" /></div>';
